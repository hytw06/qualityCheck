...
public class QualityCheck extends ChaincodeBase {

    private static Log _logger = LogFactory.getLog(QualityCheck.class);

    @Override
    public Response init(ChaincodeStub stub) {
        _logger.info("Init chaincode qualityCheck.");
    ...
    public Response invoke(ChaincodeStub stub) {
        try {
            _logger.info("Invoke chaincode qualityCheck.");
